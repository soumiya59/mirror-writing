  ...
  return (
    <section className="container bg-whitish mx-auto md:py-16 ">
      ...
      <form className="container mx-auto md:flex lg:justify-evenly text-center py-16" >
        ...
        <br />
        <textarea name="input" value={input} cols={50} rows={9} placeholder='mirrored text will appear here' className={flip?'text-xl fliped border-2 p-2 md:p-4 mt-10 md:mt-0 max-w-[90%] md:max-w-[50%]  focus:outline-none focus:ring-0': 'text-xl border-2 p-2 md:p-4 mt-10 md:md:mt-0 max-w-[90%] md:max-w-[50%] focus:outline-none focus:ring-0'} >{input}</textarea>
      </form>
